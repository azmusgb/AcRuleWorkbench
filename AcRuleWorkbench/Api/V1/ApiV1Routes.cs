...
internal static class ApiV1Routes
{
    ...
    public static IReadOnlyList<ApiRouteDescriptor> All { get; } = new List<ApiRouteDescriptor>
    {
        ...
        new ApiRouteDescriptor("GET", "/api/v1/fwd/udfs/canonical", "Canonical UDF definitions with resource evidence, private body candidates, caller bindings, and status-result evidence where available."),
