...
internal static class ApiV1Routes
{
    ...
    public static IReadOnlyList<ApiRouteDescriptor> All { get; } = new List<ApiRouteDescriptor>
    {
        ...
        new ApiRouteDescriptor("GET", "/api/v1/editor-model", "Snapshot-level canonical FormWorks Editor parity model: object graph, rule lists, UDFs, SelectionLists, and runtime impacts."),
        ...
        new ApiRouteDescriptor("GET", "/api/v1/rules/{nodeId}", "Deep rule configuration packet. Accepts node ids and RuleGuid values. Use include=subtree,references,messages for expanded sections."),
        new ApiRouteDescriptor("GET", "/api/v1/rules/{nodeId}/editor-model", "Canonical FormWorks Editor-style selected-rule packet with Rule List, Status Result, Action List, Function, parameter, and evidence sections."),
        ...
        new ApiRouteDescriptor("GET", "/api/v1/fwd/object-graph", "Canonical linked FWD object graph projection."),
        ...
        new ApiRouteDescriptor("GET", "/api/v1/fwd/fields", "FWD fields. Supports ?scopeType=...&scopeName=..."),
        ...
        new ApiRouteDescriptor("GET", "/api/v1/fwd/selection-lists", "Canonical SelectionList/table definitions with match fields, plug fields, usage links, and runtime-impact caveats."),
        ...
        new ApiRouteDescriptor("GET", "/api/v1/fwd/udfs/canonical", "Canonical UDF definitions with caller bindings and status-result evidence where available."),
        ...
        new ApiRouteDescriptor("GET", "/api/v1/fwd/runtime-impact", "Static runtime/operator-impact projection derived from functions, rule configuration, UDFs, and SelectionLists."),
