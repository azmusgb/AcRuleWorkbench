        ...
        return new
        {
            ...
            components = new
            {
                schemas = new Dictionary<string, object>
                {
                    ...
                    ["DisabledState"] = new { type = "string", description = "Structural disabled state is authoritative when a structural node is available. Flat inventory disabled state is lower-confidence audit evidence only.", @enum = new[] { "Enabled", "DisabledDirect", "DisabledInherited", "PossiblyDisabledInherited", "Unknown" } },
                    ["Confidence"] = new { type = "string", description = "Evidence confidence. High/Medium/Low/Unknown are product-safe confidence labels, not runtime certainty.", @enum = new[] { "High", "Medium", "Low", "Unknown" } },
                    ...
                    ["EvidenceClass"] = new { type = "string", description = "Trust class for the returned evidence.", @enum = new[] { "Structural", "FlatInventory", "FlatInventory+Structural", "Relationship", "Diagnostic", "ExperimentalFlow" } },
                ...
                ["scopeInventory"] = new
                {
                    ...
                    value = new
                    {
                        ...
                        data = new
                        {
                            ...
                            summary = new { total = 4863, structuralMatch = 4196, flatOnly = 667 },
                            items = new[] { new { inventoryId = "flat-000419", classification = "StructuralMatch", structuralNodeId = "node-000419", disabled = new { state = "Enabled", authority = "Structural", flatInventory = new { state = "PossiblyDisabledInherited", authority = "FlatInventory" } } } }
                        }
                    }
                }
            };
