...
public sealed class FormWorksInteropException : Exception
{
    public FormWorksInteropException(string message)
        : base(message)
    {
    }

    public FormWorksInteropException(string message, Exception innerException)
        : base(message, innerException)
    {
    }

    public static FormWorksInteropException From(string message, Exception ex)
    {
        ...
        return new FormWorksInteropException(detail, ex);
    }
}
