...
function renderGlobalNavigation(){
  ...
  ].join('')}</div><div class="scope-group global-nav-heading"><span>Definitions</span></div><div class="global-view-list" role="group" aria-label="Global resource definition views">${[
