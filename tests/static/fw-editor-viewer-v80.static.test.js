...
assert(viewerHtml.includes('data-ui-build="v80-fw-editor-viewer"'), 'viewer HTML should advertise v80 build marker');
assert(viewerJs.includes("const viewerStateBuild='v80-fw-editor-viewer'"), 'viewer JS state key should use v80 build marker');
...
assert(packageJson.includes('fw-editor-viewer-v80.static.test.js'), 'package test script should reference the v80 static test');
...
console.log('FW Editor Viewer v80 static checks passed.');
