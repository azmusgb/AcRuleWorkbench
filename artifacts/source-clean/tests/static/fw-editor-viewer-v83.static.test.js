...
assert(viewerHtml.includes('data-ui-build="v83-fw-editor-viewer"'), 'viewer HTML should advertise v83 build marker');
assert(viewerJs.includes("const viewerStateBuild='v83-fw-editor-viewer'"), 'viewer JS state key should use v83 build marker');
...
assert(viewerCss.includes('v83: the normal FW Editor Viewer shell'), 'CSS should include a final shell integrity override for v82');
...
assert(packageJson.includes('fw-editor-viewer-v83.static.test.js'), 'package test script should reference the v83 static test');
...
assert(coreTemplate.includes('data-ui-build="v83-fw-editor-viewer"'), 'core HTML template should advertise the current FW Editor Viewer shell');
...
console.log('FW Editor Viewer v83 static checks passed.');
