...
assert(viewerHtml.includes('data-ui-build="v81-fw-editor-viewer"'), 'viewer HTML should advertise v81 build marker');
assert(viewerJs.includes("const viewerStateBuild='v81-fw-editor-viewer'"), 'viewer JS state key should use v81 build marker');
...
assert(packageJson.includes('fw-editor-viewer-v81.static.test.js'), 'package test script should reference the v80 static test');
...
assert(coreTemplate.includes('data-ui-build="v81-fw-editor-viewer"'), 'core HTML template should advertise the current FW Editor Viewer shell');
...
console.log('FW Editor Viewer v81 static checks passed.');
