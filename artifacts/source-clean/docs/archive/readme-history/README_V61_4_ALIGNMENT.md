...
FW Editor Viewer is aligned as a read-only FW Editor companion for AC-related FWD configuration.

## Product boundary

- FW Editor remains the authoring, editing, testing, and saving tool.
- FW Editor Viewer is a read-only FWD configuration viewer.
